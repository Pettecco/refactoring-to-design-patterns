...
describe('MariaCharacter (after State)', () => {
  ...
  it('should stay as ice flower when already ice flower gets ice flower', () => {
    const maria = new MariaCharacter();
    maria.pickIceFlower();
    maria.pickIceFlower();
    expect(maria.getCurrentState()).toBe(MariaStateEnum.ICE_FLOWER);
  ...
  it('should stay as fire flower when already fire flower gets fire flower', () => {
    const maria = new MariaCharacter();
    maria.pickFireFlower();
    maria.pickFireFlower();
    expect(maria.getCurrentState()).toBe(MariaStateEnum.FIRE_FLOWER);
